...
core_sim:
	mkdir -p sim
	cp tb/program.hex sim/program.hex
	iverilog -o sim/core_tb.vvp -I rtl tb/core_tb.v rtl/core.v rtl/pc.v rtl/imem.v rtl/decoder.v rtl/regfile.v rtl/alu.v rtl/imm_gen.v rtl/alu_control.v rtl/dmem.v
